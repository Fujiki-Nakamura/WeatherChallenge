...
class ConvLSTMCell(nn.Module):
    ...
    def __init__(
        ...
        self.additional_convs = nn.Sequential(*[
            nn.Conv2d(
                in_channels=4 * self.hidden_dim, out_channels=4 * self.hidden_dim,
    ...
    def forward(self, input_tensor, cur_state):
        ...
        combined_conv = self.additional_convs(combined_conv)
        ...
        for i in range(0, self.num_layers):
            ...
            cell_list.append(
                ConvLSTMCell(
                    ...
                    n_additional_convs=n_additional_convs, weight_init=self.weight_init)
            )
